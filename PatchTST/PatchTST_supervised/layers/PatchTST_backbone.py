...
from PatchTST.PatchTST_supervised.layers.PatchTST_layers import *
from PatchTST.PatchTST_supervised.layers.RevIN import RevIN
...
class PatchTST_backbone(nn.Module):
    ...
    def forward(self, z):  # z: [bs x nvars x seq_len]
        ...
        z = self.head(z)  # z: [bs x nvars x pred_len] or [bs x nvars x seq_len + stride] if self supervised
